...
export default function PrescriptionDetailPage({ params }: { params: { medId: string } }) {
  ...
  useEffect(() => {
    if (params.medId) {
      fetchPrescription(params.medId);
    }
  }, [fetchPrescription, params.medId]);
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p>
                          {currentPrescription.refills || 0} remaining
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div>
            ...
            {/* Refill history section removed due to type issues */}
          </div>
        </div>
      </div>
    </div>
